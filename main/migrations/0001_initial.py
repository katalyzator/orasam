# -*- coding: utf-8 -*-
# Generated by Django 1.9.6 on 2017-03-29 09:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.CharField(max_length=1000, verbose_name='\u041e\u043f\u0438\u0441\u0430\u043d\u0438\u0435 \u043f\u043e\u0441\u0442\u0430')),
                ('text', models.TextField(verbose_name='\u0422\u0435\u043a\u0441\u0442 \u043f\u043e\u0441\u0442\u0430')),
                ('news_type', models.CharField(choices=[('uluslar', 'Uluslar arasi iliskiler'), ('ekonomi', 'ekonomi'), ('enerji', 'enerji'), ('siyaset', 'siyaset'), ('toplum', 'toplum')], max_length=100, verbose_name='\u0422\u0438\u043f \u043d\u043e\u0432\u043e\u0441\u0442\u0438')),
                ('timestamp', models.DateTimeField(auto_now_add=True)),
                ('updated', models.DateTimeField(auto_now=True)),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='publication',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.Publications', verbose_name='\u0432\u044b\u0431\u0435\u0440\u0438\u0442\u0435 \u043f\u0443\u0431\u043b\u0438\u043a\u0430\u0446\u0438\u044e'),
        ),
    ]
